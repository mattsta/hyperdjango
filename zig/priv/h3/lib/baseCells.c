...
/* `BaseCellRotation` typedef now in baseCells.h — exposed so the small
 * lookup helpers can be `static inline`. */
 ...
 */
const BaseCellRotation faceIjkBaseCells[NUM_ICOSA_FACES][3][3][3] = {
    {// face 0
     {
         // i 0
         {{16, 0}, {18, 0}, {24, 0}}, // j 0
...
/* Generated by scripts/dev/gen-base-cell-pentagon-bitmap.py — do not edit by
 * hand. */
/* 12 pentagon base cells: [4, 14, 24, 38, 49, 58, 63, 72, 83, 97, 107, 117] */
const uint64_t baseCellPentagonBitmap[2] = {
    UINT64_C(0x8402004001004010), /* base cells   0..63  */
    UINT64_C(0x0020080200080100), /* base cells  64..121 */
};

/* `_isBaseCellPentagon` is now `static inline` in baseCells.h — see the
 * comment there. The bitmap above is the only out-of-line state required. */

/* `_isBaseCellPolarPentagon` is now `static inline` in baseCells.h — see
 * the comment there. */
 ...
 */
/* `_faceIjkToBaseCell`, `_faceIjkToBaseCellCCWrot60`, and
 * `_baseCellToFaceIjk` are now `static inline` in baseCells.h. */
...
/* `_baseCellIsCwOffset` is now `static inline` in baseCells.h — see the
 * comment there. */

/* `_getBaseCellNeighbor` is now `static inline` in baseCells.h. */
 ...
 */
int H3_EXPORT(res0CellCount)(void) {
