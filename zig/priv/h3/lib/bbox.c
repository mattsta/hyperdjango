 ...
 */
/* `bboxWidthRads`, `bboxHeightRads`, `bboxIsTransmeridian`, `bboxCenter`,
 * `bboxContains`, `bboxOverlapsBBox`, `bboxContainsBBox`, `bboxEquals`,
 * `scaleBBox`, and `bboxNormalization` are now `static inline` in
 * bbox.h — see the comment there. */
